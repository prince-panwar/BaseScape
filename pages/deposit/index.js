    ...
    <div className="deposit-page bg">
      <div>
        ...
        <div className="black-card-wrapper">
          ...
          <div>
        <p>Balance</p>
            {!!userbalance && typeof userbalance === 'bigint' ?( <span style={{color:"white"}}>{formatEther(userbalance)+" $scape"}</span> ):(<span style={{color:"white"}}>{0.0+" $scape"}</span>)}
          </div>
          <div>
        <p>Locked Tokens</p>
            {!!balance && typeof balance === 'bigint' ? ( <span style={{color:"white"}}>{formatEther(userbalance)}</span> ):(<span style={{color:"white"}}>{0.0+" $scape"}</span>)}
          </div>
          </div>
          <CustomInput
             value={amount}
